    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.model_db: Dict[str, Dict] = io_utils.load_json(
            ...
            # '/home/ubuntu/.maniskill/data/tasks/bridge_v2_real2sim_dataset/bridge_v2_real2sim_dataset/custom/info_bridge_custom_v0.json'
            # "/home/ubuntu/zzm/Sim2/SimplerEnv/ManiSkill/mani_skill/examples/info_bridge_custom_v0.json"
        )
        super().__init__(
